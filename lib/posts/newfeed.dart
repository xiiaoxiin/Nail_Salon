...
class NewFeed extends StatefulWidget {
  ...
  const NewFeed({Key key, this.user}) : super(key: key);
  @override
...
class _NewFeedState extends State<NewFeed> {
          ...
          child: Padding(
              ...
              child: SingleChildScrollView(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text("Click image to take your feed picture",
  ...
  void _postuserFeedDialog() {
    if (_image == null || _descCtrl.text.toString() == "") {
      Fluttertoast.showToast(
          msg: "Image/feeds is empty!",
  ...
  Future<void> _postuserFeed() async {
    ...
    print(desc);
    http.post(
        Uri.parse("https://lowtancqx.com/s269957/nailsalon/php/insert_feed.php"),
        body: {
